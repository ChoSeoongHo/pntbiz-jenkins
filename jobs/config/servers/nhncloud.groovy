 ...
 */
return [
        'dev-yh'             : [cloudType: 'nhncloud', projectType: 'rnd', description: '용인세브란스 개발서버', playbook: '/etc/ansible/dev-yh/playbook.yml', inventory: '/etc/ansible/dev-yh/hosts-yh', suffix: 'dev-yh', defaultBranch: 'SN_YonginSev', instanceNo: 'c89473cd-83e7-40a4-bd5e-f41733a4390e', ip: '103.218.159.21', startAt: '0 8 * * *', stopAt: '30 19 * * *'],
        ...
        'mercury-x-lb-01'    : [cloudType: 'nhncloud', projectType: 'mercuryx', description: 'mercury-x-lb-01', instanceNo: '5e3e4e79-ed2e-4af3-9f16-23df863b89ea', ip: '133.186.213.174', startAt: '', stopAt: '30 19 * * *'],
        'mercury-x-lb-02'    : [cloudType: 'nhncloud', projectType: 'mercuryx', description: 'mercury-x-lb-02', instanceNo: '92a6eb73-8394-41b3-8595-d4c190c7e706', ip: '125.6.40.85', startAt: '', stopAt: '30 19 * * *'],
