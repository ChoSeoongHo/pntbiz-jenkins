...
return [
        ...
        'mercury-x-app-01'   : [cloudType: 'nhncloud', projectType: 'mercuryx', description: 'mercury-x-app-01', suffix: 'mercury-x-app-01', defaultBranch: 'develop-mercuryX', playbook: '/etc/ansible/mercury-x-app/playbook.yml', inventory: '/etc/ansible/mercury-x-app/hosts', instanceNo: '739ec127-4a44-4588-88b4-0683196e689b', ip: '133.186.213.163'],
        'mercury-x-app-02'   : [cloudType: 'nhncloud', projectType: 'mercuryx', description: 'mercury-x-app-02', suffix: 'mercury-x-app-02', defaultBranch: 'develop-mercuryX', playbook: '/etc/ansible/mercury-x-app/playbook.yml', inventory: '/etc/ansible/mercury-x-app/hosts', instanceNo: 'c9a95d17-d624-44e3-8340-99c8178340aa', ip: '133.186.213.182'],
