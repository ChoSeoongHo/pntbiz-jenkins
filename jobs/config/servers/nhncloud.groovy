 ...
 */
return [
        'dev-yh'             : [cloudType: 'nhncloud', projectType: 'rnd', description: '용인세브란스 개발서버', instanceNo: 'c89473cd-83e7-40a4-bd5e-f41733a4390e', ip: '103.218.159.21', startAt: '0 8 * * *', stopAt: '30 19 * * *'],
